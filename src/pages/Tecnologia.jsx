...
import useTecnologia from '../services/useTecnologia';
import ProductGrid from '../components/product/ProductGrid';
import SkeletonGrid from '../components/product/SkeletonGrid';

const Tecnologia = () => {
    const { tecnologia, loading, error } = useTecnologia();
    ...
    const categories = useMemo(
        () => ['Todos', ...new Set(tecnologia.map(p => p.categoria))],
        [tecnologia]
    );
    ...
    const filteredProducts = useMemo(
        () => tecnologia.filter(p => p.nombre && p.precio && p.imgurl),
        [tecnologia]
    );
